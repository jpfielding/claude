...
For HTML files: read `./references/css-foundation.md` and `./references/css-layout.md` to match the existing page's styling when inserting the verification summary.
